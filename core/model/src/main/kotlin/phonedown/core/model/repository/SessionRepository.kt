...
interface SessionRepository {
    ...
    fun observeSessionsInWindow(startEpochMillis: Long, endEpochMillis: Long): Flow<List<FocusSession>>
    
    suspend fun getRecoverableSessions(): List<FocusSession>
    
    suspend fun recordPenaltyEvent(event: PenaltyEvent)
    
    suspend fun upsertSessionWithPenaltyEvent(session: FocusSession, event: PenaltyEvent)
