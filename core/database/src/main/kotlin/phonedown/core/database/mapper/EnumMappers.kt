...
fun SessionState.toStorageString(): String =
    when (this) {
...
fun SessionResult.toStorageString(): String =
    when (this) {
...
fun String.toSessionResult(): SessionResult =
    when (this) {
...
fun PenaltyEventType.toStorageString(): String =
    when (this) {
