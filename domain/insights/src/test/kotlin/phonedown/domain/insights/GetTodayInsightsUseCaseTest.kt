...
class GetTodayInsightsUseCaseTest {
    @Test
    fun `empty sessions returns zero summary`() =
        runTest {
    ...
    @Test
    fun `single clean session in window`() =
        runTest {
            val session =
    ...
    @Test
    fun `abandoned sessions are excluded from meaningful count`() =
        runTest {
            val abandoned =
                TestFixtures.testSession(
                    id = "s1",
    ...
    @Test
    fun `session outside today window is excluded`() =
        runTest {
    ...
    @Test
    fun `multiple sessions aggregate correctly`() =
        runTest {
            val s1 =
                TestFixtures.testSession(
                    id = "s1",
